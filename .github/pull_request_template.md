...
* [ ] My build is green (Existing flaky test can fail)<sup>1</sup>.
* [ ] I have written unit and/or e2e tests for my change. PRs without these are unlikely to be merged. 
* [ ] The tests actually define testcases about the feature/fix implemented
* [ ] I have run all tests locally (including the flaky ones) and they pass <sup>1</sup>
* [ ] I haven't changed the existing tests in a significant way, as this will break functionality for existing users <sup>2</sup>
...
Notes
1. Flaky tests intermittently fail in GitHub but should always pass when you run them locally 
2. Unless a discussion has happened already in an issue and the breaking change is deemed acceptable
